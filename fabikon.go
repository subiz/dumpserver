...
// port should be 21111
func NewFabikonMgr(port int) *FabikonMgr {
	grpcServer := grpc.NewServer()
	mgr := &FabikonMgr{lock: sync.Mutex{}, posts: map[string]*header.FacebookPost{}}
	header.RegisterFabikonServiceServer(grpcServer, mgr)
